    ...
    <section className="py-24 relative container bg-slate-100">
      <div className="w-full max-w-7xl px-4 md:px-5 lg-6 mx-auto">
        ...
        {orders&& Array.isArray(orders)&& orders.length>0&&orders.map((order) => (
          <div
            key={order._id}
            className="main-box border pb-2 border-indigo-900 bg-white rounded-xl pt-6 max-w-xl max-lg:mx-auto lg:max-w-full my-20"
          >
            <div className="flex flex-col lg:flex-row lg:items-center justify-between px-6 pb-6 border-b border-gray-200 ">
              ...
              <ul className="steps steps-horizontal py-3 px-7 font-semibold text-sm leading-7 pt-11 ">
                ...
                <li
                  className={`step relative ${
                    order?.status === "Out for Delivery" ? "step-primary" : ""
                  }`}
                >
      ...
      <li className="relative flex-1 text-center">
        ...
        <div className="step w-full h-4 bg-gray-300"></div>
            ...
            <div className="w-full px-3 min-[400px]:px-6 bg-sky-50">
              {/* Single order Item */}
              {order?.orderProducts.map((singleItem) => (
                <div
                  key={singleItem._id}
                        ...
                        <div className="col-span-5 lg:col-span-1 flex items-center max-lg:mt-3">
                          <div className="flex gap-3 lg:block">
                            ...
                            <p className="lg:mt-4 font-medium text-sm leading-7 text-indigo-600">
                              {singleItem.productId.price * singleItem.quantity} Rs
                            </p>
                          </div>
                        </div>
            ...
            <div className="w-full border-t border-gray-200 px-6 flex flex-col lg:flex-row items-center justify-between ">
              ...
              <p className="font-semibold text-lg text-black py-6">
                Total Price:{" "}
                <span className="text-indigo-600">{order.totalPrice} TK</span>
              </p>
            </div>
          </div>
        ))}

        <p className="font-manrope font-bold text-2xl leading-10 text-black text-center">
          Your Order History
        </p>
        ...
        {userOrderHistory.map((order) => (
          <div
            key={order._id}
            className="main-box border border-indigo-900 bg-white  pb-2 rounded-xl pt-6 max-w-xl max-lg:mx-auto lg:max-w-full my-20"
          >
            <div className="flex flex-col lg:flex-row lg:items-center justify-between px-6 pb-6 border-b border-gray-200">
              <div className="data">
                <p className="font-semibold text-base leading-7 text-black">
              ...
              {order.status == "Cancel" ? (
                ...
                <ul className="steps steps-horizontal py-3 px-7 font-semibold text-sm leading-7 pt-11 ">
                  ...
                  <li className="step step-primary relative">
                    <span className="absolute  inset-x-0 -top-6">
                      Delivered
                    </span>
                  </li>
                </ul>
                      ...
                      <div className="grid grid-cols-5">
                        <div className="col-span-5 lg:col-span-1 flex items-center max-lg:mt-3">
                          <div className="flex gap-3 lg:block">
                            ...
                            <p className="lg:mt-4 font-medium text-sm leading-7 text-indigo-600">
                              {singleItem.price * singleItem.quantity} TK
                            </p>
                          </div>
                        </div>
